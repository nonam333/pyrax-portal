...
export default function MarketsPage() {
  ...
  return (
    <div className="min-h-screen bg-background" data-testid="page-markets">
      ...
      <div className="bg-card border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
          <div className="mb-6 md:mb-8">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-card-foreground mb-2" data-testid="text-markets-title">
              Cryptocurrency Markets
            </h1>
            <p className="text-sm md:text-base lg:text-lg text-muted-foreground" data-testid="text-markets-subtitle">
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Badge
                    ...
                    className={stat.positive ? 'bg-primary text-black text-xs' : 'bg-destructive text-white text-xs'}
                    data-testid={`badge-change-${index}`}
                  >
                    {stat.change}
                  </Badge>
                </div>
                <div className="text-xl md:text-2xl font-bold text-foreground mb-1" data-testid={`text-value-${index}`}>
                  {stat.value}
                </div>
                <div className="text-xs md:text-sm text-muted-foreground" data-testid={`text-label-${index}`}>
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      {/* Header Banner Ad */}
      <div className="w-full bg-muted/20 py-4 mt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="sticky top-4 flex flex-col items-center gap-6">
              ...
              <div className="bg-card p-4 md:p-6 rounded-lg border border-card-border w-full">
                <h3 className="text-base md:text-lg font-semibold text-card-foreground mb-3 md:mb-4" data-testid="text-quick-actions">
                  Quick Actions
                </h3>
